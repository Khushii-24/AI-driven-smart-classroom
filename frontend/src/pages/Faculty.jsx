...
export default function FacultyPage() {
  ...
  const fetchFaculty = async () => {
    setLoading(true)
    try {
      const res = await axios.get("https://ai-driven-smart-classroom.onrender.com/api/faculty")
  ...
  const handleCreateFaculty = async (data) => {
    ...
    try {
      if (editingFaculty) {
        await axios.put(`https://ai-driven-smart-classroom.onrender.com/api/faculty/${editingFaculty._id}`, data)
      } else {
        await axios.post("https://ai-driven-smart-classroom.onrender.com/api/faculty", data)
      }
      setShowForm(false)
  ...
  const handleDelete = async (f) => {
    try {
      await axios.delete(`https://ai-driven-smart-classroom.onrender.com/api/faculty/${f._id}`)
